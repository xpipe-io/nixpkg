...
let
  ...
  hash = {
    x86_64-linux = "sha256-/qrXq4cEawI+IuyVKVnAwpAkeWNswtt6LhhoNiQ2yb8=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-w3aHGPe9wnU82FGCn2WAGFn/i1aJDqgvN1tvPgoujL8=";
    aarch64-darwin = "sha256-2ZJzcpe5PQgcwJIuC7z611m9mbbNRHfFHcnWgRe1ipg=";
  }.${system} or throwSystem;
