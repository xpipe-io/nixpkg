...
let
  ...
  hash = {
    x86_64-linux = "sha256-FMVhnN0Ov2Dkc3X5amatJorSkjdaWeQ1m3KfVJ0S/bA=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-1akiHY2MpqX4bsa6miu5BxssXe2XtTGFvangdxsS3uU=";
    aarch64-darwin = "sha256-jVSmfEdZ3siPy4Cal/qgudbmuyjbEKhn802sr/+md8g=";
  }.${system} or throwSystem;
