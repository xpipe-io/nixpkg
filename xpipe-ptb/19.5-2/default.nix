...
let
  ...
  hash = {
    x86_64-linux = "sha256-pB2c8Qs2KOxL/c6zsHH2XOqFy87GBAUWXGxb4NppoFw=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-/RpL/bY5u3wyqt4Hx4GO30JYc681RmzsngPd/CjtRk8=";
    aarch64-darwin = "sha256-JJfzeVodwcVpmcUOqWVV14xyBpj/gljIzjh9H0mgNdM=";
  }.${system} or throwSystem;
