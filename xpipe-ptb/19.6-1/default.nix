...
let
  ...
  hash = {
    x86_64-linux = "sha256-utoZXqSHBmrZWJrq79yJTHOn57FSj++4+WYnQtkV4Lc=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-x6AUNTMmSPWMFxQstlh7keJRG31TX1+FRTL5Sii2qDg=";
    aarch64-darwin = "sha256-cFzHmwcryLttIiMWlL6FldSVXCmlJTLrKh32OMIQ2Qs=";
  }.${system} or throwSystem;
