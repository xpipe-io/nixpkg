...
let
  ...
  hash = {
    x86_64-linux = "sha256-pSz4dzwUt85dhb+oDauWF7lF2TZ/cp1l39KmNkkkkjk=";
    aarch64-linux = "sha256-bG07eXOyTtRd9Ttz+JNMJR+Sighkm4O7MLkMl6x/BLw=";
    x86_64-darwin = "sha256-H0m8vqATKCW2wJ/RimFxbI5SxCDHkJfghOAsZdkN9sE=";
    aarch64-darwin = "sha256-pAkI0FoW56k+5H99D9Q5FwaOmr6heeCoIbiigcRKd9g=";
  }.${system} or throwSystem;
