...
let
  ...
  hash = {
    x86_64-linux = "sha256-ZnHB/rreammMvMSq4Nc/GCnu8zf5xh3ILBVmdb1Ki+U=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-YbJUcG4Hk0yJCiD+utVNsvDqWchbl4VAdV96Ml6QnZk=";
    aarch64-darwin = "sha256-3pp2t/hQ0yDgffIVk5Y9PPcV9yVj3x4AtDApz1eTECs=";
  }.${system} or throwSystem;
