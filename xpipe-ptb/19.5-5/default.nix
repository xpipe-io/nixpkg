...
let
  ...
  hash = {
    x86_64-linux = "sha256-B8LysUUCF5+w8G5hAeExEsAo0oSm5bD60Iax1feuMTw=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-FnTPqUaeXcff2HBi6f5wuAL4ndBva/I8W+6yVC+RYKg=";
    aarch64-darwin = "sha256-FrnVzeZT7iRRHXzt3+wQnPt22gyusxV0505QiXECbJc=";
  }.${system} or throwSystem;
