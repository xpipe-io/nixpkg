...
let
  ...
  hash = {
    x86_64-linux = "sha256-bJSWW9xnU4KKydjzzmS4Kn3yIUenw2j0HpYzy6+NWm8=";
    aarch64-linux = "sha256-opkHyWqTHC9/T3heowiBFMjP5ucQHTohNylpMAN3cZ0=";
    x86_64-darwin = "sha256-uPgmG6BMJujfAr1NA45Kmoi2Tch1Nuw+pk51eJi9P1c=";
    aarch64-darwin = "sha256-uRJOkgnbrPUkTfEaa785lc53Q3eMYzkXR3Z0L/CkNIo=";
  }.${system} or throwSystem;
