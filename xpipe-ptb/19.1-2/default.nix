...
let
  ...
  hash = {
    x86_64-linux = "sha256-y9knf0ozV82B4amHQP3wq3+pCsORI4xaMuw1i2P/02M=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-Tn6pn4aqolfvBXBXueU3vvOL030QvdGSGzU8AyOYdCg=";
    aarch64-darwin = "sha256-VyjCOzuS96Xv0uJcPbKOU4OqNwob9KCux/Cl9vcCtO4=";
  }.${system} or throwSystem;
