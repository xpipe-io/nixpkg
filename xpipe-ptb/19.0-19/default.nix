...
let
  ...
  hash = {
    x86_64-linux = "sha256-x5R78uscxEPhUjb0g0RQgF3bKH6W6G2f2Vr1FLIK05M=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-Q5XccpGHxsQNSb2ONmjjlfQvM6Icp/yThQgoRtat2DE=";
    aarch64-darwin = "sha256-4DxLOepPPQhylhzRqADdP+Sn0+iwvlJxp5qSKbEsIOQ=";
  }.${system} or throwSystem;
...
in stdenvNoCC.mkDerivation rec {
  ...
  ''
    ...
    ln -s "$out/bin/${displayname}" "$out/Applications/${displayname}.app/Contents/MacOS/xpipe"
