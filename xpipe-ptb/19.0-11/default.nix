...
let
  ...
  hash = {
    x86_64-linux = "sha256-QRL7F0bAjamBCE4Q7LwbHfHeL1RzUefvWR6bspj7bLY=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-fOimo+B+tG6jpdtqKT7V4fTrvhMEWuY20SkRif5p9CI=";
    aarch64-darwin = "sha256-tE5FqT+N/tjWzfRUpKrdcamT2vkeQb2zxh4bIyRl0pc=";
  }.${system} or throwSystem;
