...
let
  ...
  hash = {
    x86_64-linux = "sha256-d5JMoX1OOAfgwvtg9HuLrJYGOyf1mEGQuG/QBkRKvZo=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-leN8XkCRh6QhgBM1o/ftMgQuPHRKCYFlyMH9V2bAQ+g=";
    aarch64-darwin = "sha256-/m3/SwcJAN1br8cXN0YjWicSjctlhRmJoxLe7685FRo=";
  }.${system} or throwSystem;
