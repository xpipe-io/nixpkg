...
let
  ...
  hash = {
    x86_64-linux = "sha256-zvUZeudNUOkq8xkPCNK+HgK4KA14grbHQNYp+9FJwpA=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-ufz3kuyzDnTdrNb3bo12zwZQpzqTfMibRTcapuOSNtM=";
    aarch64-darwin = "sha256-tJgfXHcWVPlI5C+HY7MUCqPC4kGBerDfvZ1cqKH81HY=";
  }.${system} or throwSystem;
