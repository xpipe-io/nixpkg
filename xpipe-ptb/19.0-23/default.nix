...
let
  ...
  hash = {
    x86_64-linux = "sha256-ONfsKiB6dI6Q/1QsGSY3xPdll3eQYADMMyu9aKOW4dk=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-vaSs/GI28OU2wik9yMtr/Wr0G+qqTBWQcmIu0rL5DN0=";
    aarch64-darwin = "sha256-FVQaIAXcYWJDV6Fs6xaQddhXW5Tey3sU3oLENfvxY2A=";
  }.${system} or throwSystem;
