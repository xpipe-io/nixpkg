...
let
  ...
  hash = {
    x86_64-linux = "sha256-lmn1L003eFkY9T0hx2uWvLDt0jucWoD9NSzqlVSwWiw=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-H7BB8ukiA+Y5XS/MbFhh4Lq3sLGVWvQ5+mKaFc1LTXs=";
    aarch64-darwin = "sha256-znscjv2mygqXKB4dPClfD/Wsm20TpmObZr9iEaribAY=";
  }.${system} or throwSystem;
