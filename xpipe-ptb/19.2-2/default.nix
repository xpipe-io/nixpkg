...
let
  ...
  hash = {
    x86_64-linux = "sha256-NKL/xGu3NuRMneo7yGhqM0e4EZulLflmTDcnBiOP2vw=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-DEyQjzRHqVZlrjySdNppnHCAwhP8kS1tDMbU1+U7PYQ=";
    aarch64-darwin = "sha256-1AeHBOeOuyq9XlyqlV8V181459rI6OhaqyUQRHeZ1ro=";
  }.${system} or throwSystem;
