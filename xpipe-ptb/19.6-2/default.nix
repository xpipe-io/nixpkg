...
let
  ...
  hash = {
    x86_64-linux = "sha256-iMLwQ/o55ZkBrBGSUXsFncAjVvLtJrJnsR7seMPvbwY=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-wJu/S9Fc1OCr1raYl72Q7TUtl02c2ZoZhygTRzjcGUA=";
    aarch64-darwin = "sha256-bKXnaMper8e/FyekEA75c2gIRe7pgfNgDrvtrFeiqS8=";
  }.${system} or throwSystem;
