...
let
  ...
  hash = {
    x86_64-linux = "sha256-ku1lFjbiHKgwyDrmY/nvf7fJ4erXcTIsG1GG/zr1yqc=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-t8p21o3n7ZkPNYzVrcwgZG8+lVp5DYHyFnErO/sdVVk=";
    aarch64-darwin = "sha256-kHCHCeiW6iM1RhXzXu088QRoneqsTZCoAUCajoDLnFk=";
  }.${system} or throwSystem;
