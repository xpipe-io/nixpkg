...
let
  ...
  hash = {
    x86_64-linux = "sha256-B7U/WWsSnDmhflc5vj0y8aDmBFhl/SaEBIG530J2EIs=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-WAHY2glrqRlwCOkrhRKyIrqgJQ5HSttV4Cbe2/679X4=";
    aarch64-darwin = "sha256-oulX/ZGccEuCQwoLFlb6Zriaw8jC+OC+WVdZbF+hYWY=";
  }.${system} or throwSystem;
