...
let
  ...
  hash = {
    x86_64-linux = "sha256-yd42SZs7oB01Dee6aKp6VG9kZq4r8bOYFCZtuea4zQk=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-BsJCJXVl+ksOtAT9F2cB+Egq2yHv6JQ56nal9+VdG6U=";
    aarch64-darwin = "sha256-HSENX5DbsmI+IZRo1uGWMkRTLECsMy7cMTWmdHiXNrQ=";
  }.${system} or throwSystem;
