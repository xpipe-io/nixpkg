...
let
  ...
  hash = {
    x86_64-linux = "sha256-RZJvSqoSCRdAwwLCAoLoFHqIQu4MIO0Wv+hJK8VgfxU=";
    aarch64-linux = "sha256-9jitZ8gL2H8Qry171Ebm0vGCznyt/NM5WTUHdcYdyBk=";
    x86_64-darwin = "sha256-LAYH0Mjk59t9Y9Cavy4UkFvQLctSFQcjYEGjDYzcGGY=";
    aarch64-darwin = "sha256-CeL+u0kUdx28qDB0TsqZTaPcDVeNJJ2fbShDKhUZqLk=";
  }.${system} or throwSystem;
