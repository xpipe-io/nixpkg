...
let
  ...
  hash = {
    x86_64-linux = "sha256-sa7V/oSv0qJB7BUzPIJBQbvXEa0vTUUJTZZ7GJ2NPdY=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-HXQV1nwuydHx5GGkm12zWhH/i4Av8vJnBFmtVE4aWQE=";
    aarch64-darwin = "sha256-iCp/xXhRIzX440sFgI3uIJpQG0db8idKRdAZEr+YM+U=";
  }.${system} or throwSystem;
