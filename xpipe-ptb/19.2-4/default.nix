...
let
  ...
  hash = {
    x86_64-linux = "sha256-/qlaUDTTpwf289h0e0LfHGB3n5Bc6K8UdPpnCXoQdlA=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-g0fwMx5v7ci5I0alSSa0kkKPjDS/z/RndYqd/Qqss8Y=";
    aarch64-darwin = "sha256-wRegEKYjCW6mOwAl60yuIsCty6irYJQj6tB1YqwJ73M=";
  }.${system} or throwSystem;
