...
let
  ...
  hash = {
    x86_64-linux = "sha256-qv5r5t5i7hz83PxXY+xLDs5GWV3EBP4jgc0M5DNcuzg=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-FSoSE24FFv9G33qDTZsAuLZ03Rf/6YurBkeigaV/jCE=";
    aarch64-darwin = "sha256-95L2WAX2hIEqrWYAr9J/ITtddlTm92L31OZxpqKNkQs=";
  }.${system} or throwSystem;
