...
let
  ...
  hash = {
    x86_64-linux = "sha256-R8RbNbXlQvGRGGdpGBWFsq+IqexbJc14GFQ8Mhqouy4=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-motH+onmViHGx8/ctU1vuxkGo5TAHlYVT97Xtwv5Zw0=";
    aarch64-darwin = "sha256-ig8fGZZsaOCzqJ2i4E6YQCtLQln7rDA8BEWnPhCf6Cs=";
  }.${system} or throwSystem;
