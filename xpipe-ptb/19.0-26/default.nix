...
let
  ...
  hash = {
    x86_64-linux = "sha256-ICk6ARHwNfupAn+V987NppEzsH+fpWWXCLqt327ggc4=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-Org3YGOOkyJNm+E5W95acL6gqYy5itNXOyWlGkFy1QU=";
    aarch64-darwin = "sha256-GNwVcSVMevaAKoIjvPBnEuydehvAqGlb+DG/sjZb5+8=";
  }.${system} or throwSystem;
