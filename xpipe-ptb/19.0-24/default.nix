...
let
  ...
  hash = {
    x86_64-linux = "sha256-j1ot8RDtYxnc7rPoCVGWR8Edg2HD+GGuPv+RVm2VoUQ=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-7a8mlfjO2L+/GlicvUAQ+0e5MYAJqx2rjRtvq+8kwpI=";
    aarch64-darwin = "sha256-MxaHpeboZbpqYMmG+YTIJ7IkPq504g1sEcqlIVDN8ho=";
  }.${system} or throwSystem;
