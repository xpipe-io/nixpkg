...
let
  ...
  hash = {
    x86_64-linux = "sha256-tTRORCaMjyI0eEpK1/9nUmSuqFdfMf0zfcTymTBjdOg=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-K8ps3ICYqZf5lfomW0u4m8JGByN1rorsfiBIMx/f2F4=";
    aarch64-darwin = "sha256-02rYUz4Vi1jhA4yeo4hnYaopi2tmzKMg9Jbq3hZ38qo=";
  }.${system} or throwSystem;
