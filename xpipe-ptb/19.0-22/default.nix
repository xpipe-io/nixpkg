...
let
  ...
  hash = {
    x86_64-linux = "sha256-86eZUFFqUJmARdkuGq3jxu2BM4kA9eO/+56qpuvisRw=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-oyZY0kglhnVa0vu4PIArABsbuojYBPJ2y5lli+H5BeQ=";
    aarch64-darwin = "sha256-DmuOi+CM4BIjYI0Gzcmki5Z5csedM4Fm3zIqo2hiPqY=";
  }.${system} or throwSystem;
