...
let
  ...
  hash = {
    x86_64-linux = "sha256-D5G+5+E8FdHRBduY7ynHDlbUkX9qcC1UxYqscZPoYls=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-t/44WXhZLzFJMX3f/pBHTL0326Nf9pm5PEl88aGGmnE=";
    aarch64-darwin = "sha256-DnVBoeH8F0uUObqyJHabW16+F4Vz9XFEbXZ1EvMOGoY=";
  }.${system} or throwSystem;
