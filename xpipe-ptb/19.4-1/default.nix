...
let
  ...
  hash = {
    x86_64-linux = "sha256-1cjeKA8J59OyWf6YcIWIdXnHoYoyIClEZeqSH8pYHHI=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-fCF6NdWGFsd2A3oWs3aE6XFpYi2d/ZVD7R63G+4gyJo=";
    aarch64-darwin = "sha256-8BXUb88JEDf33SoanDKYbnzwlTpHhe5eopxSlrK6QRU=";
  }.${system} or throwSystem;
