...
let
  ...
  hash = {
    x86_64-linux = "sha256-2J2XWpwtOXt4p094Ff747FUoOVDohII2lBp77AQ+iZk=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-28ijhEB2uhHGLZ9BB+f9cobBLLi4VVmI433t+0uF9ug=";
    aarch64-darwin = "sha256-+Uv0mOWEkzz1dfXtyJGvFts9IaYUnxya3CoH4AaNVE8=";
  }.${system} or throwSystem;
