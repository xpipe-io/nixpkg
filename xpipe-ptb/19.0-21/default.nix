...
let
  ...
  hash = {
    x86_64-linux = "sha256-MsLYI/l3ydq8Fvg4pPDWt/bh/zwNbhTp/vwtj/mn03E=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-UCHrQoo4RaQkJzXtYVwQwJyZaFgsxsKRHHP/+x9YLMU=";
    aarch64-darwin = "sha256-9GEMuUg2JNuPvrv/TLqkFptiCh/jR2c7T4p0Sr046MM=";
  }.${system} or throwSystem;
