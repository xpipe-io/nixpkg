...
let
  ...
  hash = {
    x86_64-linux = "sha256-nM9RiQl9V2GkpWKDAarZuIyEHcRYXniJGpsHMX6L+tw=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-GGQq+m0hirIBkZ0++VlLOTA208UXl4iCkdUVm8DBIC4=";
    aarch64-darwin = "sha256-zc0I72lmw2iQUrXvsvfv6SY6utpyAnhNfqbBqgq7B9A=";
  }.${system} or throwSystem;
