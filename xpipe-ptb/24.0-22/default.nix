...
let
  ...
  hash = {
    x86_64-linux = "sha256-7tjUipA/dfTC5DkBldI+n6bA5rQMhttrfjVRSyp/ELU=";
    aarch64-linux = "sha256-x8fY/nsxowwfYP50rCEHWtf+MxoCOWE4PJClXJCBt6s=";
    x86_64-darwin = "sha256-d4VvV8Gao5HALLunjCbELw3vzDeRREJq/7biLpJlQqg=";
    aarch64-darwin = "sha256-g/jEMeFLuLz3LeblMpsFW2MmeXciRYrr0Bxu6ZFOxDE=";
  }.${system} or throwSystem;
