...
let
  ...
  hash = {
    x86_64-linux = "sha256-PlZhwNRn2Gn32NZxpFyfAfiqT/9NxedMP57z2QxeV8Y=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-dNll5qqaPTD2yMS8S+jfJUD0YOq7EFZR2Q/+JUuo8KA=";
    aarch64-darwin = "sha256-xbS/ta4gSiHY8GOmqrK5pimc67jh+ReBRuewSXig2oc=";
  }.${system} or throwSystem;
