...
let
  ...
  hash = {
    x86_64-linux = "sha256-2W6yUbCbc13q+dPaoXc69WVy0xS2yJB0frt+FXRkrIE=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-owM6922nP0do/pI/WyFH7li9ggQJxzWk8q9tJ7REcQk=";
    aarch64-darwin = "sha256-A0N1jJDt2lsUG/JDNIk6O4Mkxs5qTDGidiUrUltVILk=";
  }.${system} or throwSystem;
