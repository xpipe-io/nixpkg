...
let
  ...
  hash = {
    x86_64-linux = "sha256-oHaFn5KeN64FcFid5FWl+v9XWXr9fbW/15koliHJh3k=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-eFQYV7Zh5HAqJacjLEIRGfDYAkWTQ/FZV+8Le+nmSz0=";
    aarch64-darwin = "sha256-KBXCULJIiOnUu6wDRm64jLZ7W/hyclYTtNQEkRtEUMQ=";
  }.${system} or throwSystem;
