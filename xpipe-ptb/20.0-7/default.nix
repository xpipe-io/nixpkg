...
let
  ...
  hash = {
    x86_64-linux = "sha256-aA8EpkDSUfC7OrQ+3jIs7l0mky8y23UnNvkEnFTeLKQ=";
    aarch64-linux = "sha256-v9McekBixMYyQHfy50w9ADmc7CC1cU8j3+v6ZvVrzyk=";
    x86_64-darwin = "sha256-nMm2EFno7YHQ1ikXmZ2Gc7LNvtJEs65+QUzGkWv7k58=";
    aarch64-darwin = "sha256-Mxa3xwGjxc+mhznON0qpcQwVJDCzNZs2+hN4dZZqWko=";
  }.${system} or throwSystem;
