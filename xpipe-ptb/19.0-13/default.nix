...
let
  ...
  hash = {
    x86_64-linux = "sha256-PcfrQv5DAyhi0sU8laOuZ2QOINDRuJIeOUL50I8ZcTs=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-83hRxfoXnmkouc5pZnZqxIMEvnFIkkD9efiE9jpTT+s=";
    aarch64-darwin = "sha256-tBdYAu1OK2Yy8YWPnpzX8Qur9eOAU0Dvs2Qh8EJQhdA=";
  }.${system} or throwSystem;
