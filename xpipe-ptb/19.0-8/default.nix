...
let
  ...
  hash = {
    x86_64-linux = "sha256-TyCFpiOwb2nIhqWQE55wIcJpqJKTzsWqux8R8NoOoBU=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-SO1RPBCwIHH7XRsPtCH7igl1i6bOizpbtJovUoGvUYk=";
    aarch64-darwin = "sha256-/VpWiOYdOec8yA/0LIar1KTlBmz4v6fGZYQ1yBTqlFw=";
  }.${system} or throwSystem;
