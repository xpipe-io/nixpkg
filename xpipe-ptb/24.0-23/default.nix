...
let
  ...
  hash = {
    x86_64-linux = "sha256-zGKAmS1l6j4a/Glbz/6bpBdO9n2iATijGr2LYz4uxQQ=";
    aarch64-linux = "sha256-7ekq4/ooMPz0V0Zdz3BNotRvgoL+5vu8BFhv2Q8hm5Y=";
    x86_64-darwin = "sha256-vUG71/AIW+eRVjCzx94Fz1BbGTowJeXixu6ziaNHO18=";
    aarch64-darwin = "sha256-NOTvi/nIK2QZpFQ/BZZ7FQlF6UCsD8uN0d6gFZEKQX4=";
  }.${system} or throwSystem;
