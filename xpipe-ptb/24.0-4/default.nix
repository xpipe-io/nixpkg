...
let
  ...
  hash = {
    x86_64-linux = "sha256-GfLSj0i4FHYOs6H4h/VqVFWZS++Wl4fXEsllhnqTYwg=";
    aarch64-linux = "sha256-D3yq4mIGWkK/Uo5WOe0eBhnG6zU2j993X2nzTTJHMpo=";
    x86_64-darwin = "sha256-arNnsue3xbQvjvG2w0S6n+I4B1z7mZUyyKpzqUpqVng=";
    aarch64-darwin = "sha256-vlGi032TospGkhrWvmUXZIOe8CreXapxyrqovVeBb30=";
  }.${system} or throwSystem;
