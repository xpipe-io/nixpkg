...
let
  ...
  hash = {
    x86_64-linux = "sha256-sJiyQmDVpBgmsIqwFKf4glagMcGOnPAJLBfbZ4L+eH8=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-Pz29AD+Z4isS4dNOxmLKGSmvKMzSnzENLcu+7o9Aovw=";
    aarch64-darwin = "sha256-EQUcP0VKbXxdvenHKrOQRfPLYg5/1yWoQBebJL6F2FI=";
  }.${system} or throwSystem;
