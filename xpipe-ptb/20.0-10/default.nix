...
let
  ...
  hash = {
    x86_64-linux = "sha256-ZOvrm0iUGBQpdo8kc9nFq6Nd9yUhOzoEYosDiplO/nQ=";
    aarch64-linux = "sha256-RTTUho86H8rtqmHgZP4wnL0ggkz+IJoduunhAIUJzgk=";
    x86_64-darwin = "sha256-nrQrwODspeqExeVPk5PrRld0SkUtulXiOobydryMRQk=";
    aarch64-darwin = "sha256-0Xze4BitZSdoxP7qQBGp0fV8MaYmZyY73obw7DracT8=";
  }.${system} or throwSystem;
