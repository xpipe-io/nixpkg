...
let
  ...
  hash = {
    x86_64-linux = "sha256-fT+MkFLjVmVUBQjWntM3PgLuCVTshtjGChX9QKQ1njA=";
    aarch64-linux = "";
    x86_64-darwin = "sha256-cHynohxcSYNe5nP5DhtWiHBtHcgOHGj4gjvPphQfIwc=";
    aarch64-darwin = "sha256-6MCQnItH9FpVVT3bFsZh1K8taszpB0bMxqDyjjiodlA=";
  }.${system} or throwSystem;
