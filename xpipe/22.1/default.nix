...
let
  ...
  hash = {
    x86_64-linux = "sha256-Rb2awR+ZzmXjrWyB8Bg2ulYWkj35u+H3ndb4AuT2X3I=";
    aarch64-linux = "sha256-kCJvl1HvSQuwYlq1saYagrzmiKOJX7gDQiuNciyLxpI=";
    x86_64-darwin = "sha256-E6Fq32aJ1oVQoWZJJwFecF4MgwjY4stCdDChzcUqkjA=";
    aarch64-darwin = "sha256-7GfFs+NfBk+0Fmt1QwUUJaCys5tlKxbJW2mRKJ7CHds=";
  }.${system} or throwSystem;
