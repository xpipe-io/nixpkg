...
let
  ...
  hash = {
    x86_64-linux = "sha256-V9tUpDxb8AeKnDGTa6V/W8lQrXWvFamF+GjNbkgaw/8=";
    aarch64-linux = "sha256-pfY/HcBm/LPZzfVCfcU9jNqlm9gMb78EE6iWL8sIO90=";
    x86_64-darwin = "sha256-80ZdrENnkX/V3qJpvbHO8HYAaTKak70g3UImwZ6miCA=";
    aarch64-darwin = "sha256-D/qpZx3cBaZkFXr/iWwWTkpyFhji4AzV2LTbbw0N/QE=";
  }.${system} or throwSystem;
