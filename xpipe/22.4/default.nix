...
let
  ...
  hash = {
    x86_64-linux = "sha256-Seds76BmPGcX7uf9fcOD6D6sgWp/CH71Z4lYWEFdX8w=";
    aarch64-linux = "sha256-sRkMqv4IrFC9OT0fqnOps51vmT8bzqTzzRJ96nhQLxQ=";
    x86_64-darwin = "sha256-NtmCxPvHNROFx0MjaopxdGwHv6l3kflXNkZsWEqMGcE=";
    aarch64-darwin = "sha256-jKkXJHSMSJp/4PwxCyjoohp+1hh6CLcGKam3yH/nRn4=";
  }.${system} or throwSystem;
