...
let
  ...
  hash = {
    x86_64-linux = "sha256-fXlepTbU17NqMZlyvn/ii/Nru5gcEw/5K2XVo0Qs1NI=";
    aarch64-linux = "sha256-0rw5TiWI6nWH9wLDhA2Ph+gHUOtF1lvKLevMM1SQAOg=";
    x86_64-darwin = "sha256-ojArf6nkfyy0XvtDbSuGJwbfFwRJ1j6PSbvJpWIdsXU=";
    aarch64-darwin = "sha256-lllfGZenuLixbWBRbhiFIb2CI/SZvF1/bcN0m4IruDA=";
  }.${system} or throwSystem;
