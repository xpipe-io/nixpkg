...
let
  ...
  hash = {
    x86_64-linux = "sha256-tr4P2OaSWv/4EEoTUOIQpZBP4xxZbrlHxNkVwYmS6Ds=";
    aarch64-linux = "sha256-D7oE6DYK+7dNiD/r0WA/h3frZKcXTH8gqQybWYFjRE0=";
    x86_64-darwin = "sha256-CTBRXraBzPYLxAf7xxwnr/dfl9aXjyA9ZCY8Hcgnc0s=";
    aarch64-darwin = "sha256-kreSTIV7xu3rdK2Hl26Sr05Zkx4tQ6HYdMGsVzUXV1E=";
  }.${system} or throwSystem;
