...
let
  ...
  hash = {
    x86_64-linux = "sha256-36bkc4/JPUUyghFKqnGHyq6UFuFNW3xvQ9bfxgzx42E=";
    aarch64-linux = "sha256-a3ON/bFGNlUZX05EY+KqpIEqVkoz9xrzha7we9I/UFg=";
    x86_64-darwin = "sha256-aeN3fx9l91U22+5kKmjeuNXhPX6g6wC36kAIS/apnHk=";
    aarch64-darwin = "sha256-/kUS6qc+05DyDUWug2HPdj3E/cHqupUwYARNwFJWgsM=";
  }.${system} or throwSystem;
