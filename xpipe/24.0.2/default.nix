...
let
  ...
  hash = {
    x86_64-linux = "sha256-V/W+PT9nTk/aN+zGRMI+nVy+9lVDQJZJkhsvtDZBeRk=";
    aarch64-linux = "sha256-HcrF/V8plcZwcBYWgjlo4EszumLzgxVyDuT3vapdTOE=";
    x86_64-darwin = "sha256-/EST7YW9cy5wGG4+5r8p/30bkYX1wvYzM3cfxOxQ57E=";
    aarch64-darwin = "sha256-+4L5dlarQoVhqPNGy/HakxMkXhrwt+elrGJwXgZBnmo=";
  }.${system} or throwSystem;
