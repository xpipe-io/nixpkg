...
let
  ...
  hash = {
    x86_64-linux = "sha256-mvWyE5B20PcUEOUYWrjFSm1C+b/d3mKZaFJhU7nVd58=";
    aarch64-linux = "sha256-fObYmRfJwW+afPCnS0Q/MrPPG+4SKOdX5fEpxifBKqM=";
    x86_64-darwin = "sha256-5E/m6o6lSvgyqvhSFFE0ZIwaK/4yK8gP0mbq18kAsfk=";
    aarch64-darwin = "sha256-73qhSOQxHCF5fODbntJfjZWWpOvBkB2ffaWU91DikX4=";
  }.${system} or throwSystem;
