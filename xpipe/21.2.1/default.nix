...
let
  ...
  hash = {
    x86_64-linux = "sha256-zOCuS4COeLRWwDu4tvfcqdtL1bBUMajchm+DwNJ1NeE=";
    aarch64-linux = "sha256-lEup95cmyT2RlIs6hi8r4cZKiQww8QLvQ3Om5r+PEU0=";
    x86_64-darwin = "sha256-sVTdQnZ/LyVJSwBd7PQiTwBbmiekDxO96Ax4hDd38rc=";
    aarch64-darwin = "sha256-0VoV6kA8XwRiT7hvbREwt4ETdFkUcWpFOHVtHXdpx6o=";
  }.${system} or throwSystem;
