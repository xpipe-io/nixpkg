...
let
  ...
  hash = {
    x86_64-linux = "sha256-OkdSqF6PqnS92/fRvHL4t8TZrz1qR1ao965vRrSgwdo=";
    aarch64-linux = "sha256-FJVIbKXus3TB0XkhoVluK/pgGsew6PuY06s/6kXFH4o=";
    x86_64-darwin = "sha256-xB48BQyAvEI2AsBHpgv2RXtxn/1adv2D3FExsrm6Qls=";
    aarch64-darwin = "sha256-wxjXziJawyCG3qovgenRq+7pbCKvXinE5rLjWSxwG0Q=";
  }.${system} or throwSystem;
