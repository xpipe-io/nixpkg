...
let
  ...
  hash = {
    x86_64-linux = "sha256-9HtNIPY2Xszx5zFYilcGYKWppgB1WEPezrqIO49+Da4=";
    aarch64-linux = "sha256-UzDyka6E3Q6lfznp2HwfSe8/BMfX9z+F4Xeipamgbn8=";
    x86_64-darwin = "sha256-GPu4p7m1fOP0CMI5X9GGzrd3YX+IEikBdC9EOqg+3GY=";
    aarch64-darwin = "sha256-ALBfiE3Fhkw1xESbj6RMQxtvDfu56IUZuVSucGzJs4c=";
  }.${system} or throwSystem;
