...
let
  ...
  hash = {
    x86_64-linux = "sha256-K0h3qKRKAxVjb/qM3XatRBwta2TQvfBKJrirF2Y1nXI=";
    aarch64-linux = "sha256-lgj8gIUSImBRtiJrzHaE9QAkeGyAmlggcpnDAw850/A=";
    x86_64-darwin = "sha256-jz/qUvwnp23ukijRdsoi+byro/gJWIIP4h9lGvRF4TM=";
    aarch64-darwin = "sha256-+Q5QHZ5MCO6ENS6P+yTLP05LLAVvW51FeVXT13p8caw=";
  }.${system} or throwSystem;
