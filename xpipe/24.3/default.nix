...
let
  ...
  hash = {
    x86_64-linux = "sha256-v5QUPHwzyp7dBZ+LbHQOPvm5cKqwu46pVCHGS9eluZs=";
    aarch64-linux = "sha256-stMsPKteFObRgSUZh+Zq7MzmnejQ+/9P8CjVplj5H/8=";
    x86_64-darwin = "sha256-WeLAReUqsHgfxr0s9LUC+uyQ9KzsLY+6vl2JdPAZRng=";
    aarch64-darwin = "sha256-fA0W9Acjto9FDs+Ty7Ebr5fkuN+5fe8ikYCjMUOcAjc=";
  }.${system} or throwSystem;
