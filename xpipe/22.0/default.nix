...
let
  ...
  hash = {
    x86_64-linux = "sha256-uVH58GJilcaQsq0dtArcJe/bPRRJ5Ta/kCM2JmaO02Q=";
    aarch64-linux = "sha256-gqGSL/qpGL3DN2b5uPkeaN/na0F+1QRgmRViaym+qAc=";
    x86_64-darwin = "sha256-F9x1vUvRj/PTJpDG7ib+yOoavFpGIS5b0LdKTGpBw1M=";
    aarch64-darwin = "sha256-qSgftDpBbtpHw5Oz74VonE3N4SY/iY6fA4q9yJ5phMA=";
  }.${system} or throwSystem;
