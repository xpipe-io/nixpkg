...
let
  ...
  hash = {
    x86_64-linux = "sha256-cEkqx0cwukp4y0vmRz/OUCeii9IKAKuj1z+OFiS5d2Y=";
    aarch64-linux = "sha256-d1veZeJ2bRDsUFeul/IG+DteaDDgHptNbhuZ5rIlM1E=";
    x86_64-darwin = "sha256-85OhpYqU107cfx2btxOzkavmCDTd/MFVB6cDa3GXZ3k=";
    aarch64-darwin = "sha256-NVANX9l3PWyW9LW2gzDvDn/FznhFI3dr44fwvlCxutY=";
  }.${system} or throwSystem;
