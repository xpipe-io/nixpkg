...
let
  ...
  hash = {
    x86_64-linux = "sha256-bicRIALA1x+EP/elnBIs0OFz4gZkwx4HwooZPGi7RyA=";
    aarch64-linux = "sha256-PbOAo6TYK6GHtj+z6ASMbKfl/bX8jy4iZL1SBNOvCcU=";
    x86_64-darwin = "sha256-13m1rEXBsmfmE3EeRnn9+aSNcAcQi75NQBRIRr+CVjw=";
    aarch64-darwin = "sha256-deDpuBTA9bSCUUzr0WS0GOr+W7EtQW+wHqRJ7ZUqAHg=";
  }.${system} or throwSystem;
