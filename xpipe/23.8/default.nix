...
let
  ...
  hash = {
    x86_64-linux = "sha256-nN12zMEIhyTgX04I2I8UG1y5ArB8ot3f1yw3iecpUo4=";
    aarch64-linux = "sha256-huH+1ypG+DCAZGangwbCgee5fzA9MY5SkdengL5cEAo=";
    x86_64-darwin = "sha256-KnI9G5+Vxi/VEo6M6luXNLCAw4loiK3KB1dI8LR9To4=";
    aarch64-darwin = "sha256-ASV16holM7xOJQFqlXB2fg/pxaEgkYEOqdlpmcby6HU=";
  }.${system} or throwSystem;
