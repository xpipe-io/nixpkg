...
let
  ...
  hash = {
    x86_64-linux = "sha256-WC4EZ/si/NydO0af9MPBHezIC2/6HUrqkfidzEQd8MY=";
    aarch64-linux = "sha256-xbKNwKaRxqvdWRuBXzfHykRrt8u5SfucntaT2+yKOHY=";
    x86_64-darwin = "sha256-8+zxI8YKW/GLFuFsp8VAHP2jF8wjai2U+GrPlWiyWJA=";
    aarch64-darwin = "sha256-aZb1a0PjQM+/310lmxy/YflGFQlLSLGEcnwoH3/5f58=";
  }.${system} or throwSystem;
