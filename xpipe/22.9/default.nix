...
let
  ...
  hash = {
    x86_64-linux = "sha256-4NxFGs3+0pJQr+zdqQaU44yGwV1SWOGlgr6+9RzKRsY=";
    aarch64-linux = "sha256-eD3yjZv/29Wj5pcyQg4FoAzELtZ9YFfD9Lck7e3Vn6o=";
    x86_64-darwin = "sha256-KC6tJIrHZEuBscXjHgJuXGHRlYIiqdCNEXJKOK752rE=";
    aarch64-darwin = "sha256-8T9K3bj8a7/skLLxQ+DiEXTx+VtGR/Z+Fd7YM1eUhH0=";
  }.${system} or throwSystem;
