...
let
  ...
  hash = {
    x86_64-linux = "sha256-eksgOK8VkNnQP88smIgz/Ybkxh0olNzZOTBlnEjFb28=";
    aarch64-linux = "sha256-6irQLjK1UT023/4w29ef40JuE1ojswjD66E1hiuz/6A=";
    x86_64-darwin = "sha256-aoAeCjnzi4JGp+Fewo6YOTtMLOCu7wmW4+EAWcxSq7g=";
    aarch64-darwin = "sha256-kMMARxVU4EhQNw91Qv2CqsteIC+kBaBSLKx2SY/WaEc=";
  }.${system} or throwSystem;
