...
let
  ...
  hash = {
    x86_64-linux = "sha256-6BqUShQyzri+tYvtkhCBjhL1gi2InM4I0eLiD1dLWHo=";
    aarch64-linux = "sha256-DHvHR7UwUbtmcs9RGUjRQn0wussTIVDrV4Ynasx6hfE=";
    x86_64-darwin = "sha256-eEdQpS5Jinx1vCPKeGdmIpUI79BdknAjZpQGqMlUGQg=";
    aarch64-darwin = "sha256-EN/xRIK6wdQ3Rw8Tq7aQEJjGHVQI44eZIOeOWVbLVjA=";
  }.${system} or throwSystem;
