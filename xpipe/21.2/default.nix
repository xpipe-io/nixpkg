...
let
  ...
  hash = {
    x86_64-linux = "sha256-vjYViAuwcaTMDlRwrv895yRVmwcy17GJimTYFZ4mvXw=";
    aarch64-linux = "sha256-gSN8/XMQSMivLIU/zq8qa5gul21ZHBOlDgX0DT2M8KQ=";
    x86_64-darwin = "sha256-qrckgUf2p1ni9AIMNBxjgVkSJqo2V8fZxMdt3mBiMRQ=";
    aarch64-darwin = "sha256-kDXmI3s49UE8c6PuRXaxeaLIAZNuL08DBrhD6vWplCM=";
  }.${system} or throwSystem;
