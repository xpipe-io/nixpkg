...
let
  ...
  hash = {
    x86_64-linux = "sha256-DUjlb/VvTCSbjhP6+s3YJ9WndlJ0BYtNyJ1FtXa7QsY=";
    aarch64-linux = "sha256-2AlwMxp/hnL6r4Q/2hAgUilCf4fMr7YkY8SMDJZPf+Q=";
    x86_64-darwin = "sha256-NNkHqPYqr+CTDmaEmAlaJTPkeDzhn+zyCACtOIaZXrc=";
    aarch64-darwin = "sha256-dqUVdFHj5NKlsLY5KcdXZ4S9T8uloPTtl5kFKVK3ZJQ=";
  }.${system} or throwSystem;
