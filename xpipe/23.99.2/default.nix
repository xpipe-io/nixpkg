...
let
  ...
  hash = {
    x86_64-linux = "sha256-eFU9J5gUFSMTZtbqFSIVLFp1DruHBo+6rVudoP0hLmA=";
    aarch64-linux = "sha256-+J93Ybeigtv9NjnUjvC2ewi6sFbjtWirpw6F9WXyCso=";
    x86_64-darwin = "sha256-VkTCJqdVFtvmUPGeo30p3LZmBXiR2FX7gWIMEVNaoQo=";
    aarch64-darwin = "sha256-rPgbIYXiVHMCYFkD/lhBKesAWQwdQVtRCjxDVqymB+I=";
  }.${system} or throwSystem;
