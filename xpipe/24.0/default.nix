...
let
  ...
  hash = {
    x86_64-linux = "sha256-7eZx/q64cWcGHw5+K4nLcroNzJLPHgSgi8m8aXtgjMY=";
    aarch64-linux = "sha256-JYSSCa3zuqjt4alfCFgsM5wYwJk7wM611K5gDFD8eGs=";
    x86_64-darwin = "sha256-3IWVjt6ekBn4NdIy1DCKBjPI7YOklZKGtsIFTCq08as=";
    aarch64-darwin = "sha256-/fEoma5FAFkGJXp8ep9BWWtD9JHqoQ9z60ZRUkwomvM=";
  }.${system} or throwSystem;
