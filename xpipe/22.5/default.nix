...
let
  ...
  hash = {
    x86_64-linux = "sha256-JtKsXQ/p2R3L86Fdy6SIYFIz/PM++1ZOb73DCUYekKY=";
    aarch64-linux = "sha256-/GyPp3hw9zHRom/I1Pg/IRK4pmEMgeAGTaZwsflP7t8=";
    x86_64-darwin = "sha256-5QEPaHysT7eRS/FTKsWmWXfNVAhwwd3WMRAue4mEbms=";
    aarch64-darwin = "sha256-JDydkKtQSICO2VNnfs86VVdUj0VTZmcITr0II6wwXMA=";
  }.${system} or throwSystem;
