...
let
  ...
  hash = {
    x86_64-linux = "sha256-BTyG5PgAtsslBuwfstg81kyNAYBr3U0A7TqA1sThbcg=";
    aarch64-linux = "sha256-mB1NovLRv81qxuJoY7STNVJq5uyzv3DbCG/mayO6Ow0=";
    x86_64-darwin = "sha256-anNE0NLvZoF6/GPIImpwpMgXym+Cjo9AY5VHheJSlME=";
    aarch64-darwin = "sha256-ETlVZqvXwZJn/ZNPyJvYx28rYrmt+bpAK4YEloYNdxU=";
  }.${system} or throwSystem;
