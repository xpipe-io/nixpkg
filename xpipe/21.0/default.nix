...
let
  ...
  hash = {
    x86_64-linux = "sha256-jHblGtZJPy3fFXX3ZbTCQwIORX84NeFoQOcWuHyjTeU=";
    aarch64-linux = "sha256-dzYzEPMaeeol8KDchNlXfMkv3AUbYpwsXSZfgbHkdsc=";
    x86_64-darwin = "sha256-2cexQWA/0tDZTfP8VbMKkk4gft61JrQgbnSI7haja4g=";
    aarch64-darwin = "sha256-Rt9i63jh4oq8myslUZqNwPWjj+xd1jLWurDdzMhqUok=";
  }.${system} or throwSystem;
