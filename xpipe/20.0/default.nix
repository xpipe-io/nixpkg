...
let
  ...
  hash = {
    x86_64-linux = "sha256-xO3iLTObhY4BaS475iuPtFhEZ+pof+VHKwRi+5c8Tzo=";
    aarch64-linux = "sha256-pl3My07eXQYZ04IcHNMYTON0BKRAFLTwoT+mKPo+gT4=";
    x86_64-darwin = "sha256-/dtHjewPBofeBOH7pBFvxvUr/2WDHVmTlFU+Rw8mlY0=";
    aarch64-darwin = "sha256-ZPOO8S7OeFLQq1sT8uxwTESNbkoC4qvQtkDDN2v5f+8=";
  }.${system} or throwSystem;
