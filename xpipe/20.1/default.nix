...
let
  ...
  hash = {
    x86_64-linux = "sha256-AwcypCxp+s3tSMBf6ym4N/JP9Svbz5Edn4BFNX1VQH8=";
    aarch64-linux = "sha256-mVqMxP2zpB/sEloLwkqGP86vemNIzUBOlI/NXh+wJOU=";
    x86_64-darwin = "sha256-ivsSCtd0Tk+1ITjT2DwUbm9LBkjoiSqgdQeh+GoQjY8=";
    aarch64-darwin = "sha256-JRe9/+i4wbzclUS7gdzPRRiRyt3LV+hB6ssR/hjM/Ag=";
  }.${system} or throwSystem;
