...
let
  ...
  hash = {
    x86_64-linux = "sha256-JoeJdJmxntSqvKEpj4gCulSpu+bqyEXxshGY/oXWkBE=";
    aarch64-linux = "sha256-lCDURiWZyE/MbJnTDD703pf1S9ykzgfzQ341fGwxFNk=";
    x86_64-darwin = "sha256-+avBqn86AupJCnMSMHv98rlJMR28dA9QotOzyrERkyE=";
    aarch64-darwin = "sha256-9f5XiLZ9Nclp3cWiMvkshcZv+qkk1afGwfR9FfH5zoc=";
  }.${system} or throwSystem;
