...
let
  ...
  hash = {
    x86_64-linux = "sha256-bQWWfjnS6CoiteTjni87ADUdVguj06lRS3UQ8Tnn6b0=";
    aarch64-linux = "sha256-W3hNz0IRQ2LVlYau4TsuMVerpF2pJksByFRlBJR5kIs=";
    x86_64-darwin = "sha256-AuAcoPVjspND5LyhtR+GOuReXkFStl0seJQ2IfPNLNM=";
    aarch64-darwin = "sha256-RJ3ekhn0ZirUl3MXSTu2McKH+ImQ4b2R1XRIpz36iC4=";
  }.${system} or throwSystem;
