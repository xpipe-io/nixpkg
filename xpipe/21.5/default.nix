...
let
  ...
  hash = {
    x86_64-linux = "sha256-eg+7sNLfwDRLVOC/P8kePHfDjAMDFQMhGNKUt0gCI9Y=";
    aarch64-linux = "sha256-8YPRzm8fNbd/mOlSY6jLb9QcbVeChNsr1zuCoQUvkgU=";
    x86_64-darwin = "sha256-MG/dfuBXTUZ/dJjINdcQgXHFnN0DilbJy9KA2mITZWI=";
    aarch64-darwin = "sha256-5e+oPD6UChERYQYfKHQXQWgD5co5QnixeJK4m3wikfY=";
  }.${system} or throwSystem;
