...
let
  ...
  hash = {
    x86_64-linux = "sha256-19L1fFIZWzGhJdRZmSX+rNpX4RQwTTFrUJuURZkLSg0=";
    aarch64-linux = "sha256-xxItmx+ZNxz5onAAADyIdC1dcMZBT6AD61j7z1SQsb4=";
    x86_64-darwin = "sha256-rWgvqgDen54SofkXzSjoLbpxDV7GcuiGYcXESetlxt4=";
    aarch64-darwin = "sha256-dWfRat2dGXGB7brK+wEeuFFcb+qo+ROTIkcAZoi+d+Q=";
  }.${system} or throwSystem;
