...
let
  ...
  hash = {
    x86_64-linux = "sha256-Uwh7M1emkq6ZtjH+BNYQVFcL8QrpXOQoXIJDWdfafSA=";
    aarch64-linux = "sha256-F/g0ByggvF2mQlG6Kxut5QumT5Mu8nR1LFjLBOI5MX4=";
    x86_64-darwin = "sha256-vLGl/yGuVwdsDEvj1yURpOYuQiqJt8bJN+drjePvqc0=";
    aarch64-darwin = "sha256-aO4R3WVs9HvUADgDAShKLP1UDlLClE1OoUUOGM0y22Q=";
  }.${system} or throwSystem;
