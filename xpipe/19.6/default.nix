...
let
  ...
  hash = {
    x86_64-linux = "sha256-lLyVGOGxFPKHNOR5YnOh7DKYb3CfOwdOMEq4b8kDvfY=";
    aarch64-linux = "sha256-7RC7xXSlyNWFcCGaGIH4orEpEYQ5cpaDhTSOePwZgPU=";
    x86_64-darwin = "sha256-Pjsz0PaN2Ey3DCnxY3lcoaaQgr7g+UeFLD9HyRch/Ow=";
    aarch64-darwin = "sha256-vLS7LBewDx4nhv3K6EVj18FyQPk1UO+eR6Jv6YVhh6w=";
  }.${system} or throwSystem;
