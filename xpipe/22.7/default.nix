...
let
  ...
  hash = {
    x86_64-linux = "sha256-F8D7UjDqBODvrTkim62KZ+4fVLuYDdlWFXusMPeChlY=";
    aarch64-linux = "sha256-OTMAETZ24T4P7737vVbLUkKoSw3YsRfs6zJUK6IL9Sw=";
    x86_64-darwin = "sha256-epxbDQpDmvptftn3Z2JQiq8UKUiNXxJ1nYebJMOuOVA=";
    aarch64-darwin = "sha256-QWcPYt37OhhEGdzgsYlvQUBcWS2l7uK8k4wwbez9t2Q=";
  }.${system} or throwSystem;
