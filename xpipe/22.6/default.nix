...
let
  ...
  hash = {
    x86_64-linux = "sha256-rjxbGaobjOGeLUxCikj2y/NJIo7TKiGKgw1558kcRRg=";
    aarch64-linux = "sha256-+0o8sl71+8S2I822Z6UVIVA5ItOe/onGn3A4fH2IFoI=";
    x86_64-darwin = "sha256-7Oy10TH64qGxKmhLX/E6vNvoZrvfg4p2dY3WreCZy1I=";
    aarch64-darwin = "sha256-y4uEdHDr5KYavBEtJHEPrAnAmSoHx1XzLJ1wg8XwcaQ=";
  }.${system} or throwSystem;
