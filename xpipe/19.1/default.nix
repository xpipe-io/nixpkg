...
let
  ...
  hash = {
    x86_64-linux = "sha256-3fmV+caGUum0PytgB8ABR572GDBuv0jTNBGFbqeokxo=";
    aarch64-linux = "sha256-EGUU7Qz1Un/aZypvvVBCk8oHfs70z96hiZsH5LzVtnQ=";
    x86_64-darwin = "sha256-7koEIiZ3/QB2+W4bOscb8qk3l/9kT1EQgLhFrugt444=";
    aarch64-darwin = "sha256-LMUFyGpeilpb4gXKQTdwUqAnkwxTjPPp1pUpvmLH4AI=";
  }.${system} or throwSystem;
