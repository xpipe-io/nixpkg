...
let
  ...
  hash = {
    x86_64-linux = "sha256-MVz2/7CVi3F4EGD+33ABJ3bjwFUt5jleMtaXh60bkCU=";
    aarch64-linux = "sha256-2PnTMER/GRxAK0IGIHSSgKeqgCHedRss/TPurWDX6nQ=";
    x86_64-darwin = "sha256-DRQxEL2Rz5PW0SfD+8Bf/aE0ogL++Rg1H/n8h6frQe8=";
    aarch64-darwin = "sha256-K/Tupefc6oUXDaatkYdBirBjLwn2DjJxCFWaCi5zkt8=";
  }.${system} or throwSystem;
