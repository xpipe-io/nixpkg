...
let
  ...
  hash = {
    x86_64-linux = "sha256-SKkeb0TYkDT8JOl8i36FmVwb2rUphyv5ghjpAObKXrw=";
    aarch64-linux = "sha256-hNu5qychrAxvIs5xfSzhHI52c8vgybDWwsCvieuiKSo=";
    x86_64-darwin = "sha256-an/iTQ6VYJ6/ALal+LpiSrqjBaSbr2PkYrger2FoL+c=";
    aarch64-darwin = "sha256-aUZvKW7g5bn1szjZvbqgFzEadJepGeY5vuU5EYFaM0w=";
  }.${system} or throwSystem;
