...
let
  ...
  hash = {
    x86_64-linux = "sha256-5ygnJJkk2XDQLGn9ftbXYBNCxiPxTENflbnuGQzdxcU=";
    aarch64-linux = "sha256-YEN6IkwJO4PLIWtgUp2aYlgHBbsU+bGeWpks3oOZ26I=";
    x86_64-darwin = "sha256-v/m3vD4UpO6ZVLd8ANL0h/SkF8II7huBLGM2E8Zdzfw=";
    aarch64-darwin = "sha256-61gIish59wTrzPv9EEhivgpuJEKrwiNOMZQf4PeKcrE=";
  }.${system} or throwSystem;
