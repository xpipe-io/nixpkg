...
let
  ...
  hash = {
    x86_64-linux = "sha256-GpCk3RhJGrp0gtBYAm25nq8dnU3ZsGIwzYSAvjW4pM0=";
    aarch64-linux = "sha256-viOwgmzh+Dye5ze4rX6Y/THuHz9qhiBa/AHE8NC80vc=";
    x86_64-darwin = "sha256-VY/Bb49GAOL28vZBRcTg53ogn4fQO27o26/x664PWho=";
    aarch64-darwin = "sha256-vt7s8pc9T/WAOHzHKn4+y1hx0cmMxm+88tsmV26+hos=";
  }.${system} or throwSystem;
