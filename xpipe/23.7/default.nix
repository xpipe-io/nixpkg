...
let
  ...
  hash = {
    x86_64-linux = "sha256-zIigWYXPVbvUUgRx4wJ4+fmKLOZTutri58kNRT3TfEI=";
    aarch64-linux = "sha256-FANhUOAZ4GJFD59fG+BD4VwTLQiaX+Db4iW9eradmzA=";
    x86_64-darwin = "sha256-hGuS3QIlkxCO9xKZfrNhVaYF25wsYlzoWd5YqdqNO1M=";
    aarch64-darwin = "sha256-zq6kt4MI1DyKngqfkaVvTudEf4FLOm9Fw7MEm5QEqFk=";
  }.${system} or throwSystem;
