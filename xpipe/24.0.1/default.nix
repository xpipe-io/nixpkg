...
let
  ...
  hash = {
    x86_64-linux = "sha256-c7snzebA1OKR+UjsosTix/Q2tljc3pQRdMMLbxAY5lc=";
    aarch64-linux = "sha256-JWSQ+QibQXQx0P5dW8UKv8PoO8CNp8MncyRvjSyrYVA=";
    x86_64-darwin = "sha256-rwIdQrL8TPe3EF0BSRaWd7Z+1QUdx35XxBhCxD0/Wyc=";
    aarch64-darwin = "sha256-1NDxn2U9lif6PJNCkU0sMFCW/Y68WnSLkcYs8bW8gcE=";
  }.${system} or throwSystem;
