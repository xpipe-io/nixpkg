...
let
  ...
  hash = {
    x86_64-linux = "sha256-hdBJqIRJVnICR/o4G7mbEhGz9O3Bceeh6EBWfJ9Lmtc=";
    aarch64-linux = "sha256-KUMeBOBEW6LzQt/PDFyihYCvMk+G36dkFuAtXQxwOkY=";
    x86_64-darwin = "sha256-7UIbB9H1Bh/ZIOpfHf7OX/HxES3rhQMekisERTG4LqY=";
    aarch64-darwin = "sha256-rLYFWEs3/Ajx19RzYvdC6Su7DJm+AeAPnDZMXLaqUpE=";
  }.${system} or throwSystem;
