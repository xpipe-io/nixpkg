...
let
  ...
  hash = {
    x86_64-linux = "sha256-KiivVs+Ot0UqnwCAyod0akybLU8H9psxWn5IVYLGVMM=";
    aarch64-linux = "sha256-2SRwVmWe00DrRWfSADJzfw4j8iYwIRNVPPLVPLgEi74=";
    x86_64-darwin = "sha256-W6NEuwyYL8gXvsRJOfxGaqppgMx3q4oMruBQ3jIEMLQ=";
    aarch64-darwin = "sha256-oLw0tLVaeMN7sdEo4TZi9l3jaLZv2tgLYqoXsShBbz8=";
  }.${system} or throwSystem;
