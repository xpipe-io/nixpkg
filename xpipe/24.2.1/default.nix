...
let
  ...
  hash = {
    x86_64-linux = "sha256-tniKQUObjBTIWDF51neKIgMUk4lpaoehQQ6i+Jq85FY=";
    aarch64-linux = "sha256-RMchNkwrqVnjI4cnvZrTKkeLlkiY0F/h533gcegbrJY=";
    x86_64-darwin = "sha256-aIv6CFxW+RKjOORdk9S7dVWOTzpGweEVYg1m34BwI6A=";
    aarch64-darwin = "sha256-FPC/7zwlRGublFTWBFjf+CuEWBwLx7aBgKGDGHbrkxk=";
  }.${system} or throwSystem;
