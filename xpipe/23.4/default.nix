...
let
  ...
  hash = {
    x86_64-linux = "sha256-cLpsWsmYgTRcDCtqpmnfWdbD5+gZzaKv518jkourTIY=";
    aarch64-linux = "sha256-gi6h3IR2Z8SMGC2Ljv14JfcJrXI2iAmOxoAIV16z5+A=";
    x86_64-darwin = "sha256-QRjQi+ogE0f5pxYZrfBrpAUhvfBfZKDPwRQI1LE/Bik=";
    aarch64-darwin = "sha256-6Y4WGxgqUelc87F2l6bLpFCEv4AfX42fUOHs+PBqXGw=";
  }.${system} or throwSystem;
