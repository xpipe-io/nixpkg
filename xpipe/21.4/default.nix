...
let
  ...
  hash = {
    x86_64-linux = "sha256-R8PaoBtxCvMHVs5ICPoGvgwYJb4htr2cnZ2OHhnaAmQ=";
    aarch64-linux = "sha256-2aSmhladY8U/E4SnxYn3U0qBABc5dklh6j+fA/WlOHQ=";
    x86_64-darwin = "sha256-HLc3cBn906W/kCTZnaUfQ6wWZ3T+iYwXRB1LKRH+EZY=";
    aarch64-darwin = "sha256-aUyuLLGosev8h6+dP5VNsSZO4lL8Igk3jL1udiVcbkM=";
  }.${system} or throwSystem;
