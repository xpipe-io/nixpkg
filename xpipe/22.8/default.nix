...
let
  ...
  hash = {
    x86_64-linux = "sha256-/5Eq9bWTfPdbyjtIrlFoWLrzjSFd157dCoGwjiRd4Tw=";
    aarch64-linux = "sha256-AJ/yoarmUo/4nb7VVFPsUmypfWf2bWCu4MuFYUYotW8=";
    x86_64-darwin = "sha256-tgefdWQO9U/EsGUeGZgz4nvJ8DFNtNK+Pm+IHjgrjeQ=";
    aarch64-darwin = "sha256-y30uHtGNmam2SZMvRJCXJKlkTBQPZCObLtteMtkGON4=";
  }.${system} or throwSystem;
