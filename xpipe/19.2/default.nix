...
let
  ...
  hash = {
    x86_64-linux = "sha256-bpzatUgf8EbtBD7au9g7jDopxgjFo5sWaMMQDzRq+iQ=";
    aarch64-linux = "sha256-0yN9ACurzlzfTH96g06r85nhnwgmThQCvPae6Z81ejU=";
    x86_64-darwin = "sha256-QDB8jepRD5vPjjbfGsCuL3OU+od7BvPb6eU1/DfWGKI=";
    aarch64-darwin = "sha256-5j+dGmpow+NBHSMvc8yDmMO1HPeZF0WgNnIFKIjHMiI=";
  }.${system} or throwSystem;
